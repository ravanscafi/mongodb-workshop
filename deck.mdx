...
<Head>
    {useFullscreenKeys()}
    <title>Workshop PHP + MongoDB</title>
...
<FullPageImage src="images/prisma-comparison.png" alt="Comparing Database Types" />
...
<div style={{overflowY: 'scroll', overflowX: 'hidden', minWidth: '100vw', minHeight: '100vh', position: 'relative'}}>
    <img src="images/localhost.jpg" alt="Localhost" style={{width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, objectFit: 'cover'}}/>
</div>

---

<FullPageImage src="images/validation.png" alt="Laravel Validation Rules" />
...
## Considerações
<Appear>
<li>O MongoDB evoluiu muito, com validações, "joins", transactions...</li>
<li>Outros bancos correram muito atrás de recursos do MongoDB</li>
<li>Avalie seu uso, não existe bala de prata!</li>
</Appear>
...
[bit.ly/avalie-phpcs-2019](http://bit.ly/avalie-phpcs-2019)
